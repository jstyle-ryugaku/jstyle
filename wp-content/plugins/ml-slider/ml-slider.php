...
//        }
    ...
    public function print_slideshow_selector() {
        ...
        if ($tabs = $this->all_meta_sliders()) {
            ...
            if ('tabs' == $this->get_view()) {
                ...
                // Render the tabs
                echo "<div class='nav-tab-wrapper' style='display: none;'><!-- 非表示にしました -->";
                    foreach ($tabs as $tab) {
                        if ( $tab['active'] ) {
    ...
    public function render_admin_page() {
        ...
        echo "<div class='wrap metaslider-ui-top' style='margin-top:0; display: none;'><!-- 非表示にしました -->";
        ...
        <div class="wrap metaslider metaslider-ui">
            <h1 class="wp-heading-inline metaslider-title" style="display: none;"><!-- 非表示にしました -->
            ...
            <form accept-charset="UTF-8" action="<?php echo admin_url( 'admin-post.php'); ?>" method="post">
                ...
                <div id='poststuff' class="metaslider-inner wp-clearfix" style="border: none; background-color: transparent; padding: 0;"><!-- 書き換えました -->
                        ...
                        <div id="postbox-container-1" class="postbox-container ml-sidebar metaslider-settings-area">
                            ...
                            <?php } else {?>
                                <div class="ms-postbox" id="metaslider_configuration">
                                    ...
                                    <div class="inside wp-clearfix" style="display: none;"><!-- 非表示にしました -->
                                ...
                                <div class="ms-postbox ms-toggle closed" id="metaslider_advanced_settings" style="display: none;"><!-- 非表示にしました -->
                                ...
                                <a class='delete-slider alignright ml-has-icon ml-button ml-delete-button' href='<?php echo $url ?>' style="display: none;"><!-- 非表示にしました -->
                                    <i>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
                                    </i>
                                    <span><?php _e( "Delete Slideshow", "ml-slider" ) ?></span>
                                </a>
                            </div>
                            <?php } ?>
                        </div>
