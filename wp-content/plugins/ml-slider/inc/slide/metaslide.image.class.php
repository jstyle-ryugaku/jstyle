...
class MetaImageSlide extends MetaSlide {
    ...
    private function get_flex_slider_markup( $slide ) {
        ...
        $attributes = apply_filters( 'metaslider_flex_slider_list_item_attributes', array(
                ...
                'style' => "display: none; width: 100%; /* まじか */",
...
//        $li .= ">" . $html . "</li>";
        ...
        $html  = '<a class="item" href="' . (strlen($anchor_attributes['href']) ? $anchor_attributes['href'] : 'javascript:void(0);') . '" target="' . $anchor_attributes['target'] . '">';
