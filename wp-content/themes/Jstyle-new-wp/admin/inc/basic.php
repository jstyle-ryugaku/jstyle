...
function add_basic_tab_panel( $options ) {
	...
	global $dp_default_options, $font_type_options, $headline_font_type_options, $load_icon_options, $load_time_options, $hover_type_options, $hover2_direct_options, $sns_type_top_options, $sns_type_btm_options;
...
function add_basic_theme_options_validate( $input ) {
	...
	global $font_type_options, $headline_font_type_options, $load_icon_options, $load_time_options, $hover_type_options, $hover2_direct_options, $sns_type_top_options, $sns_type_btm_options;
