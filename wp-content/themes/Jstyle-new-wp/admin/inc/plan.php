...
<div id="tab-content6">
    ...
    <p><label><?php _e( 'Font size', 'tcd-w' ); ?> <input class="hankaku tiny-text" type="number" min="1" name="dp_options[plan_ph_catchphrase_font_size]" value="<?php echo esc_attr( $options['plan_ph_catchphrase_font_size'] ); ?>"> px</label></p>
		<p><label><?php _e( 'Font color', 'tcd-w' ); ?> <input type="text" name="dp_options[plan_ph_color]" value="<?php echo esc_attr( $options['plan_ph_color'] ); ?>" data-default-color="<?php echo esc_attr( $dp_default_options['plan_ph_color'] ); ?>" class="c-color-picker"></label></p>
		<p><label><?php _e( 'Background color', 'tcd-w' ); ?> <input type="text" name="dp_options[plan_ph_bg_color]" value="<?php echo esc_attr( $options['plan_ph_bg_color'] ); ?>" data-default-color="<?php echo esc_attr( $dp_default_options['plan_ph_bg_color'] ); ?>" class="c-color-picker">
  ...
  <div class="theme_option_field cf">
	...
	<div class="theme_option_field cf a-plan-list-num">
  	...
  	<h4 class="theme_option_headline2"><?php _e( 'Background color of plan list on hover', 'tcd-w' ); ?></h4>
		<input type="text" class="c-color-picker" name="dp_options[plan_list_overlay]" value="<?php echo esc_attr( $options['plan_list_overlay'] ); ?>" data-default-color="<?php echo esc_attr( $dp_default_options['plan_list_overlay'] ); ?>">
