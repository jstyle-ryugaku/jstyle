...
<div id="tab-content3">
	...
	<div class="theme_option_field cf">
  	<h3 class="theme_option_headline"><?php _e( 'Splash page settings', 'tcd-w' ); ?></h3>
		<p><label><input type="checkbox" name="dp_options[display_splash]" value="1" <?php checked( 1, $options['display_splash'] ); ?>> <?php _e( 'Display splash page', 'tcd-w' ); ?></label></p>
  		  ...
  		  <div class="image_box cf">
  		  	...
  		  	<div class="image_box cf">
  		   		<div class="cf cf_media_field hide-if-no-js">
  		    		...
  		    		<div class="button_area">
  		     			<input type="button" value="<?php _e( 'Select Image', 'tcd-w' ); ?>" class="cfmf-select-img button">
  		     			<input type="button" value="<?php _e( 'Remove Image', 'tcd-w' ); ?>" class="cfmf-delete-img button <?php if ( ! $value['hero_header_image' . $i] ) { echo 'hidden'; } ?>">
  		    		</div>
  		   		</div>
  		  	</div>
  		  </div>
