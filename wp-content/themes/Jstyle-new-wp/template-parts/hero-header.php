...
<div id="js-hero-header" class="p-hero-header">
    ...
    <div id="js-hero-header__content1" class="p-hero-header__content is-active p-hero-header__content--desktop"
         style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/top/header.png);">
    </div>
    <div id="js-hero-header__content1" class="p-hero-header__content is-active p-hero-header__content--middle"
         style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/top/header_middle.png);">
    </div>
    <div id="js-hero-header__content1" class="p-hero-header__content is-active p-hero-header__content--sp"
         style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/top/header_middle.png);">
    </div>
...
<style>
    ...
    .p-hero-header__content--desktop {
        display: block;
    }

    .p-hero-header__content--middle,
    .p-hero-header__content--sp {
...
<!-- 	<div id="js-hero-header" class="p-hero-header">
		...
		<ul class="p-hero-header__nav u-clearfix">
			<?php for ($i = 1; $i <= 4; $i++) : ?>
			<li class="p-hero-header__nav-item<?php if (1 === $i) {
    echo ' is-active';
} ?>"><a href="<?php echo esc_url($options['hero_header_url' . $i]); ?>" data-target="#js-hero-header__content<?php echo esc_attr($i); ?>"><span class="p-hero-header__nav-item-title" style="font-size: <?php echo esc_attr($options['hero_header_catch_font_size' . $i]); ?>px;"><?php echo esc_html($options['hero_header_catch' . $i]); ?></span></a></li>
			<?php endfor; ?>
		</ul>
		<?php
    for ($i = 1; $i <= 4; $i++) :
        ...
        ?>
		<div id="js-hero-header__content<?php echo $i; ?>" class="p-hero-header__content<?php if (1 === $i) {
        echo ' is-active';
