	...
	<style>
        ...
        <div class="wrap">
         ...
         <div id="mono_instructions">
          ...
          <p style="font-size:16px;">【 <a href="http://tcdwp.info/dl050/gensen/gensen_tcd050.zip">最新版のテーマをダウンロードする</a> 】</p>
          <div id="mono_info">
	   <h3>更新情報</h3>
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_gensen.xml';

    $db_cache_field = 'gensen-contempo-notifier-cache';
