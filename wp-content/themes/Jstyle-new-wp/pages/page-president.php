...
<main class="l-main">
    ...
    <div class="president-wrapper">
        ...
        <div class="photo-message">
            <div class="photo" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/president/president.jpg')"></div>
            <h2 class="top-message">
                留学を通して<br>「自分の夢を、自由なやり方で、自分で切り開く “若者”」<br>を増やしたい
            </h2>
        </div>
