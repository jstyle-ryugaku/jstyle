...
<main class="l-main">
    <div class="main-content-container">
        <h1>プライバシー・ポリシー(個人情報の取り扱いについての指針)</h1>
        <p>株式会社Jstyle(以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
        ...
        <div>
            <ul>
                <li>住所：〒179-0074 東京都練馬区春日町2丁目14番47号 シュエット203</li>
                <li>社名：Jstyle</li>
                <li>TEL： (03) 5848-5432</li>
                <li>Email：info@jstyle-ryugaku.com</li>
            </ul>
        </div>
