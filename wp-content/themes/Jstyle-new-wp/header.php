    ...
    <header id="js-header" class="l-header<?php if ('type2' === $header_fix) {
        ...
        <nav id="js-global-nav" class="p-global-nav u-clearfix">
            <ul class="l-header__menu">
                <li><a href="<?php echo home_url('/') ;?>"><span class="menu-button--ja">トップページ</span><span class="menu-button--en">Home</span></a>
                </li>
                <li><a href="<?php echo home_url('/about') ;?>"><span class="menu-button--ja">Jstyleについて</span><span
