...
?>
  ...
  <div id="tab-content9">
   ...
   <div class="theme_option_field cf">
    ...
    <h4 class="theme_option_headline2"><?php _e('Background color', 'tcd-w'); ?></h4>
    <input type="text" class="c-color-picker" name="dp_options[footer_bg_color]" value="<?php echo esc_attr( $dp_options['footer_bg_color'] ); ?>" data-default-color="<?php echo esc_attr( $dp_default_options['footer_bg_color'] ); ?>" />
    <input type="submit" class="button-ml" value="<?php echo __( 'Save Changes', 'tcd-w' ); ?>" />
   </div>
